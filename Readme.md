# Climatological Data Analysis & ML Feature Engineering (Ibadan: 2001–2025)
...
![Warming Stripes](assets/fig1_warming_stripes.png)
...
![Dual Heatmaps](assets/fig2_heatmaps.png)
...
![Wind Rose](assets/fig3_wind_rose.png)
...
![Ridgeline Distribution](assets/fig4_ridgeline.png)
...
![Energy Scatter](assets/fig5_energy_scatter.png)
...
### 6. Climate Radar: Multivariate Seasonal Cycles
![Climate Radar](assets/fig7_climate_radar.png)
...
### 7. Temperature Trend Decomposition: Granular Time-Series
![Trend Decomposition](assets/fig8_temp_decomp.png)
...
4. Run `python src/visualize.py` to compile the visual diagnostics into the `/assets` directory.# climate-analysis
